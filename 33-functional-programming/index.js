const instructors = ['evans', 'dick ward', 'chris', 'charlie', 'steven balasta', 'humzah', 'zach']
//
...
isCallBackTrue(functionWithArgs(arg1,arg2))

functionWithArgs(anArg,notherArg){
...
isCallBackTrue(alwaysTrue)


const outerFn = function(argument) {
